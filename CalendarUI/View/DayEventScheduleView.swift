...
//        let event1StartTime = calendar.date(from: DateComponents(year: 2022, month: 12, day: 10, hour: 12, minute: 00, second: 0))!
//        let event1EndTime = calendar.date(from: DateComponents(year: 2022, month: 12, day: 10, hour: 13, minute: 30, second: 0))!
...
//        let event2StartTime = calendar.date(from: DateComponents(year: 2022, month: 12, day: 10, hour: 12, minute: 30, second: 0))!
//        let event2EndTime = calendar.date(from: DateComponents(year: 2022, month: 12, day: 10, hour: 13, minute: 0, second: 0))!
